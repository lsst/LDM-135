...
\item
  ...
  rows and updates occur every \textasciitilde{}39 sec \citep{Becla07}.
\item
...
database \citep{dbms210} and expects to deploy a 36 petabyte system
...
\item
  ...
  r-tree-based indexes such as the TOUCH \citep{Nobari13}.
\item
...
\citep{Kunszt} for partitioning and spatial indexing. These schemes can
